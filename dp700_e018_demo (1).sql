...
VALUES
('alice@labskraft.com', 'north');


/**************************************************************************************/

--Granting access on table level (OLS)
GRANT SELECT ON dp700_e018.finance TO [alice@labskraft.com'];
GRANT SELECT ON dp700_e018.sales TO [alice@labskraft.com'];
GRANT SELECT ON dp700_e018.user_region TO [alice@labskraft.com'];

--Grating access on column level (CLS)
GRANT SELECT ON dp700_e018.employees(employee_id, full_name, department) TO [alice@labskraft.com'];
